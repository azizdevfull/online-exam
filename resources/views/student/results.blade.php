...
@section('space-work')
    ...
    <table class="table">
        ...
        <tbody>
            ...
            @else
                <tr>
                    <td colspan="4">You no attempted ane Exam!</td>
                </tr>
            @endif
        </tbody>
      ...
      <!-- Modal -->
  <div class="modal fade" id="reviewQnaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
